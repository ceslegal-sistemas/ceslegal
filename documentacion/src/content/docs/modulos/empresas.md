---
title: Empresas
description: Modulo de gestion de empresas que sirve como base del multi-tenancy en LUPE Legal
---

## Descripcion General

El modulo de **Empresas** gestiona las organizaciones registradas en LUPE Legal. Cada empresa es la unidad base del sistema multi-tenant: los trabajadores, procesos disciplinarios, usuarios y documentos estan vinculados a una empresa especifica. El modelo `Empresa` es la raiz del arbol de datos de cada cliente.
