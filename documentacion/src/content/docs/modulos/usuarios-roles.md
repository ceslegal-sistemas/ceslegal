...
description: Sistema de autenticacion, autorizacion y gestion de roles con Filament Shield en LUPE Legal
---

## Descripcion General

El modulo de **Usuarios y Roles** gestiona la autenticacion, autorizacion y control de acceso en LUPE Legal. Utiliza **Filament Shield** (basado en Spatie Permission) para la gestion granular de permisos, combinado con **Policies** de Laravel para la autorizacion a nivel de modelo.
