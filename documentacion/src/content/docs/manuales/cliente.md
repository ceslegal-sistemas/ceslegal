...
description: Guia completa para el usuario con rol cliente en LUPE Legal
---

## Descripcion del Rol

El **Cliente** (rol `cliente`) es el representante de la empresa que utiliza el sistema LUPE Legal para gestionar los procesos disciplinarios de sus trabajadores. Este rol tiene un alcance limitado a los datos de **su propia empresa**.
...
Segun la legislacion laboral colombiana, la citacion a descargos debe notificarse al trabajador con suficiente anticipacion. LUPE Legal requiere un minimo de **5 dias habiles** antes de la fecha programada para la diligencia.
:::
