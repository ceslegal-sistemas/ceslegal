...
return [
    ...
    |
     */
    // El "user" de level-up es la Empresa, no el User autenticado - el logro
    // le pertenece a la empresa (una empresa puede tener varios usuarios
    // 'cliente'), no a la persona que hizo clic en un momento dado.
    'user' => [
        'foreign_key' => 'empresa_id',
        'foreign_key_type' => 'bigint',
        'model' => App\Models\Empresa::class,
        'users_table' => 'empresas',
    ],
    ...
    */
    ...
    |
    */
    // Solo se usan Achievements por ahora - multiplicadores/niveles/tope de
    // nivel/tiers/desafíos/leaderboard quedan apagados explícitamente (no
    // vía .env, para que no dependa de configurarlo aparte en cada entorno).
    'multiplier' => [
        'enabled' => false,
