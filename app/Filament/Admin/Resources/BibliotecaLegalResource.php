        ...
        return $table
            ...
            ->headerActions([
                Tables\Actions\Action::make('importar_corte')
                    ...
                    ->modalDescription('Se descarga el texto oficial de cada sentencia desde la página de la Corte Constitucional y se procesa con embeddings. Enfoque curado: usted elige qué sentencias entran a la base.')
                    ...
                    ->form([
                        Forms\Components\Textarea::make('referencias')
                            ...
                            ->helperText('Formatos válidos: T-1040/2006, C-200/2019, SU-049/2017. La descarga y el procesamiento corren en segundo plano; recibirá una notificación por cada una.'),
                    ])
                    ->action(function (array $data): void {
                        ...
                        Notification::make()
                            ...
                            ->body($refs->count() . ' sentencia(s) en cola. Le avisaremos cuando cada una termine.')
                            ->info()
                            ->send();
                    }),
            ])
