...
class TrabajadorPolicy
{
    ...
    {
        return $user->can('force_delete_trabajador');
    }
    ...
    {
        return $user->can('force_delete_any_trabajador');
    }
    ...
    {
        return $user->can('restore_trabajador');
    }
    ...
    {
        return $user->can('restore_any_trabajador');
    }
    ...
    {
        return $user->can('replicate_trabajador');
    }
    ...
    {
        return $user->can('reorder_trabajador');
    }
}
