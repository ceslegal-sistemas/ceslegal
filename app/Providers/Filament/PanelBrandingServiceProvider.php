 ...
 * Table::configureUsing() se registran GLOBALMENTE salvo que se pase
 * `scopes:` - si este contenido se hubiera duplicado en el boot() de un
 * segundo PanelProvider, el CSS/JS de marca habría salido repetido dos veces
 * en cada página. Un ServiceProvider normal (no PanelProvider) que se
 * registra una sola vez en bootstrap/providers.php evita el problema.
 */
class PanelBrandingServiceProvider extends ServiceProvider
{
