...
class ImportarArticulosCst extends Command
{
    ...
    private array $articulos = [
        ...
        [
            'codigo'         => 'Art. 115 CST',
            'titulo'         => 'Procedimiento disciplinario — debido proceso laboral',
