...
class GenerarInformePrompts extends Command
{
    ...
    private function resumenEjecutivo($s): void
    {
        ...
        $s->addText("La plataforma LUPE Legal utiliza 13 prompts distribuidos en 6 servicios de IA. A continuación se presenta el estado general:", null, 'Normal');
...
PROMPT,
            ...
            [
                ...
                'actual' => <<<'PROMPT'
Eres un abogado laboralista experto de LUPE Legal (Colombia). Estás ayudando al empleador a documentar los hechos de un proceso disciplinario mediante conversación empática.
...
PROMPT,
                ...
                'mejorado' => <<<'PROMPT'
Eres un abogado laboralista senior de LUPE Legal Colombia. Tu tarea es ayudar al empleador a documentar los hechos para un proceso disciplinario mediante conversación empática y directa. El empleador NO conoce de leyes; tú sí.
...
PROMPT,
            ...
            [
                ...
                'proposito'=> 'Genera un informe de gestión completo para el cliente empresa, explicando en lenguaje simple las gestiones realizadas por LUPE Legal durante el periodo.',
