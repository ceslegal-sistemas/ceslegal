...
{
    // Datos de LUPE Legal (proveedor de servicios jurídicos)
    protected const CES_LEGAL = [
        'razon_social' => 'LUPE Legal S.A.S.',
        'nit' => '901.258.505-4',
    ...
    protected function construirPromptInformeLenguajeClaro(
        ...
        return <<<PROMPT
Eres un abogado senior con 15 años de experiencia redactando informes de gestión jurídica. Trabajas para LUPE Legal S.A.S. y estás escribiendo un informe profesional para tu cliente {$empresa->razon_social}.
...
4. Cuál es el valor que LUPE Legal aporta

INFORMACIÓN DEL INFORME:
- Firma proveedora: LUPE Legal S.A.S. (nosotros)
...
- Menciona el compromiso de LUPE Legal con su empresa
...
- Reafirma el compromiso de LUPE Legal
...
Es un placer presentarles el informe de gestión jurídica correspondiente al periodo actual. En LUPE Legal S.A.S. nos enorgullece trabajar como su aliado estratégico en materia legal, protegiendo los intereses de su empresa y brindando soluciones oportunas a sus necesidades jurídicas.
...
Agradecemos su confianza en LUPE Legal S.A.S. Estamos comprometidos con la protección legal de su empresa y seguiremos trabajando para brindarle el mejor servicio. No dude en contactarnos para cualquier consulta o necesidad adicional. Quedamos a su entera disposición.
TEXT;
    }
    ...
    protected function generarHTMLInforme(
        ...
        $fechaActual = Carbon::now()->locale('es')->isoFormat('D [de] MMMM [de] YYYY');
        $nombreAbogado = $abogado->name ?? 'Equipo LUPE Legal';
        $logoPath = base_path('documentacion/src/assets/logo.png');
        $logoBase64 = file_exists($logoPath)
            ? 'data:image/png;base64,' . base64_encode(file_get_contents($logoPath))
            : '';
        $logoHtml = $logoBase64
            ? "<img src=\"{$logoBase64}\" alt=\"LUPE Legal Digital\" style=\"height:28px;width:auto;display:block;\">"
            : '<span style="font-size:9pt;font-weight:bold;color:#B71C1C;padding:0 4px;">LUPE Legal</span>';
...
<head>
    ...
    <title>Informe de Gestión Jurídica - LUPE Legal</title>
    <style>
...
<body>
    ...
    <div id="page-footer">
        ...
        <table class="pf-table">
            <tr>
                ...
                <td class="pf-right">LUPE Legal S.A.S. &nbsp;·&nbsp; NIT 901.258.505-4 &nbsp;·&nbsp; {$fechaActual}</td>
            </tr>
        </table>
    ...
    <div class="firma-section">
        ...
        <div class="firma-linea">
            ...
            <div class="firma-cargo">Abogado - LUPE Legal S.A.S.</div>
...
HTML;
    ...
    protected function crearHojaResumen(Spreadsheet $spreadsheet, Empresa $empresa, int $anio, ?string $mes, Collection $informes, array $resumenPorArea, array $resumenPorTipo, array $resumenPorEstado, ?array $resumenPorMes): void
    {
        ...
        $sheet->setCellValue('A1', 'INFORME DE GESTIÓN JURÍDICA - LUPE Legal S.A.S.');
