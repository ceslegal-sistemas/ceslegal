        ...
        return [
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    '   b) Duración máxima: para contratos indefinidos la duración máxima es la que indique el contexto jurídico inyectado. Para contratos a término fijo, el período de prueba no puede exceder la quinta parte (1/5) del término pactado.',
                    '   c) Prohibición en contratos sucesivos: cuando el trabajador ya prestó servicios al mismo empleador para el mismo cargo, NO puede pactarse nuevo período de prueba. El contexto jurídico inyectado indica las condiciones exactas.',
                    '   d) Terminación durante el período: cualquiera de las partes puede terminar el contrato durante el período de prueba sin lugar a indemnización, pero sí con preaviso si así lo establece la norma.',
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    '   a) La jornada máxima legal semanal según Art. 161 CST (modificado por Ley 2101/2021) es de 42 horas semanales. Este es el límite vigente. Menciónalo explícitamente.',
                    '   b) Definición de trabajo diurno (entre las 6 a.m. y las 9 p.m.) y trabajo nocturno (entre las 9 p.m. y las 6 a.m.) según lo establezca el contexto jurídico inyectado.',
                    '   c) La jornada diaria máxima sin horas extras. El límite exacto proviene del contexto jurídico inyectado.',
                    ...
                    'C. DESCANSO DOMINICAL REMUNERADO: artículo independiente sobre el derecho al descanso dominical remunerado. Indicar que el trabajador tiene derecho al descanso remunerado en domingos y días festivos. El salario por ese día de descanso y las condiciones exactas provienen del contexto jurídico inyectado (Art. 179 CST).',
                    'D. TRABAJO EN DÍA DE DESCANSO OBLIGATORIO — artículo independiente obligatorio con:',
                    '   a) Cuando el trabajador labora excepcionalmente en su día de descanso obligatorio (domingo o festivo), tiene derecho a un recargo sobre el salario ordinario. El porcentaje exacto del recargo proviene del contexto jurídico inyectado (Art. 180 CST).',
                    '   b) DESCANSO COMPENSATORIO: el trabajador que trabaje en su día de descanso habitual tiene derecho a un descanso compensatorio remunerado. Las condiciones exactas provienen del contexto jurídico inyectado (Art. 181 CST).',
                    '   c) TÉCNICOS Y ESPECIALIZADOS: para trabajadores de labores técnicas que requieren continuidad, las reglas especiales de remuneración y compensación provienen del contexto jurídico inyectado (Art. 182 CST).',
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    '   a) Los períodos máximos de pago según el tipo de salario: jornal (se paga por días, máximo semanalmente), sueldo (mensual). Los períodos exactos provienen del contexto jurídico inyectado (Art. 134 CST).',
                    ...
                    'C. PROHIBICIÓN DE PAGO EN ESPECIE NO AUTORIZADA: artículo expreso sobre la prohibición de pagar el salario con fichas, vales, mercancías, bonos u otros sustitutos del dinero. Esto está prohibido por el CST (Art. 136 y concordantes). El texto exacto proviene del contexto jurídico inyectado.',
                    ...
                    'E. IGUALDAD SALARIAL: artículo autónomo sobre el principio de igual salario por trabajo de igual valor, sin discriminación por razón de sexo, raza u origen. El texto y referencias exactas provienen del contexto jurídico inyectado (Art. 143 CST).',
                    'F. PROPINAS: artículo sobre la naturaleza jurídica de las propinas y que no constituyen salario. El texto exacto aplicable proviene del contexto jurídico inyectado.',
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    'E. PROCEDIMIENTO DISCIPLINARIO COMPLETO — artículo que reproduzca fielmente los requisitos del Art. 115 CST. Usar TABLA con las etapas:',
                    '   TABLA:',
                    ...
                    '   FILA: 2. Plazo de descargos | El trabajador tiene el plazo legal (mínimo 5 días hábiles salvo que la norma indique otro) para preparar y presentar sus descargos por escrito.',
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    'FILA: Multa en dinero | Descuento salarial. El límite máximo de la multa por cada infracción y el porcentaje exacto del salario que puede descontarse están establecidos en el contexto jurídico inyectado (Art. 113 CST). El producto de las multas se destina exclusivamente al fondo de premios y regalías para los trabajadores de la empresa. | Faltas leves y graves según gravedad.',
                    'FILA: Suspensión sin remuneración | Interrupción temporal del contrato sin pago. La duración máxima de la suspensión por primera vez y la duración máxima acumulada en el año están fijadas por el contexto jurídico inyectado (Art. 112 CST). | Faltas graves.',
                    ...
                    'IMPORTANTE: el límite máximo de la multa (porcentaje del salario diario) y el límite en días de suspensión provienen ÚNICAMENTE del contexto jurídico inyectado. NO uses cifras de tu entrenamiento.',
                ]),
            ],
            [
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    'Este capítulo es OBLIGATORIO por Ley 1010 de 2006 y Ley 2365 de 2024. Cada artículo mínimo 80 palabras.',
                    'A. ACOSO LABORAL — DEFINICIÓN Y MODALIDADES: artículo autónomo completo que defina el acoso laboral como toda conducta persistente y demostrable ejercida sobre un empleado por parte de un empleador, jefe o superior jerárquico inmediato o mediato, un compañero de trabajo o un subalterno. Luego detallar con ejemplos concretos cada modalidad: 1) Persecución laboral; 2) Discriminación laboral; 3) Entorpecimiento laboral (obstáculos que impidan el trabajo); 4) Inequidad laboral (asignación de tareas denigrantes); 5) Desprotección laboral. Las referencias normativas provienen del contexto jurídico inyectado.',
                    ...
                    '   c) Período de gestión de 2 años, con posibilidad de reelección.',
                    '   d) Reuniones ordinarias (mínimo una vez por trimestre) y extraordinarias cuando se requiera.',
                    '   e) Quorum: mínimo el 50% de sus miembros.',
                    '   f) Actas de reunión como constancia de las actuaciones.',
                    'C. FUNCIONES DEL COMITÉ — artículo completo: recibir y dar trámite a las quejas de acoso laboral; escuchar a las partes involucradas; promover acuerdos conciliatorios entre las partes; formular planes de mejora para convivencia laboral; hacer seguimiento a las medidas adoptadas; reportar a la alta dirección los casos y sus resultados.',
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    '   c) INDEMNIZACIÓN ADICIONAL: si el empleador despide a la trabajadora sin la autorización requerida, debe pagar adicionalmente, a título de indemnización, el valor establecido en el contexto jurídico inyectado (Art. 239 CST).',
