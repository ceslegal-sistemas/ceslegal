        ...
        return [
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    '   b) Duración máxima según el tipo de contrato (indefinido y término fijo). Las duraciones exactas provienen del contexto jurídico inyectado.',
                    '   c) Prohibición en contratos sucesivos: cuando el trabajador ya prestó servicios al mismo empleador para el mismo cargo, no puede pactarse nuevo período de prueba. Las condiciones exactas provienen del contexto jurídico inyectado.',
                    '   d) Terminación durante el período: cualquiera de las partes puede terminar el contrato durante el período de prueba. Las condiciones provienen del contexto jurídico inyectado.',
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    '   a) La jornada máxima legal semanal vigente. El número exacto de horas proviene del contexto jurídico inyectado. Menciónalo explícitamente en el artículo.',
                    '   b) Definición de trabajo diurno y trabajo nocturno con los horarios que establezca el contexto jurídico inyectado.',
                    ...
                    'C. DESCANSO DOMINICAL REMUNERADO: artículo independiente sobre el derecho al descanso dominical remunerado en domingos y días festivos. El salario por ese día y las condiciones exactas provienen del contexto jurídico inyectado.',
                    'D. TRABAJO EN DÍA DE DESCANSO OBLIGATORIO — artículo independiente obligatorio con:',
                    '   a) Recargo por trabajar excepcionalmente en día de descanso obligatorio (domingo o festivo). El porcentaje exacto del recargo proviene del contexto jurídico inyectado.',
                    '   b) DESCANSO COMPENSATORIO: derecho del trabajador que labora en su día de descanso habitual. Las condiciones exactas provienen del contexto jurídico inyectado.',
                    '   c) TÉCNICOS Y ESPECIALIZADOS: reglas especiales de remuneración y compensación para trabajadores de labores técnicas que requieren continuidad. Las condiciones exactas provienen del contexto jurídico inyectado.',
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    '   a) Los períodos máximos de pago según el tipo de salario (jornal y sueldo). Los períodos exactos provienen del contexto jurídico inyectado.',
                    ...
                    'C. PROHIBICIÓN DE PAGO EN ESPECIE NO AUTORIZADA: artículo expreso sobre la prohibición de pagar el salario con fichas, vales, mercancías, bonos u otros sustitutos del dinero. El texto exacto proviene del contexto jurídico inyectado.',
                    ...
                    'E. IGUALDAD SALARIAL: artículo autónomo sobre el principio de igual salario por trabajo de igual valor, sin discriminación por razón de sexo, raza u origen. El texto y referencias exactas provienen del contexto jurídico inyectado.',
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    'E. PROCEDIMIENTO DISCIPLINARIO COMPLETO — artículo que reproduzca fielmente el procedimiento legal. Usar TABLA con las etapas:',
                    '   TABLA:',
                    ...
                    '   FILA: 2. Plazo de descargos | El trabajador tiene el plazo legal que establezca el contexto jurídico inyectado para preparar y presentar sus descargos por escrito.',
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    'FILA: Multa en dinero | Descuento salarial. El límite máximo de la multa por cada infracción y el porcentaje del salario descontable provienen del contexto jurídico inyectado. El producto de las multas se destina al fondo de premios y regalías para los trabajadores de la empresa. | Faltas leves y graves según gravedad.',
                    'FILA: Suspensión sin remuneración | Interrupción temporal del contrato sin pago. La duración máxima de la suspensión por primera vez y la duración máxima acumulada provienen del contexto jurídico inyectado. | Faltas graves.',
            ...
            [
                ...
                'instrucciones' => implode("\n", [
                    ...
                    '   c) Período de gestión según lo establezca el contexto jurídico inyectado, con posibilidad de reelección.',
