            ...
            x-data="{
                ...
                toggleAll: function () {
                    ...
                    this.checkboxes.forEach(checkbox => {
                        if (checkbox.checked === this.state) {
                            return;
                        }

                        checkbox.checked = this.state;

                        // Ajuste: los métodos de Filament arriba (toggleAllCheckboxes,
                        // etc.) no cubren TODOS los checkboxes cuando hay muchos
                        // recursos con permisos (24+ en este proyecto) - fijar
                        // .checked directamente NO dispara el evento 'change', asi
                        // que Livewire nunca se entera del cambio y el permiso no
                        // queda guardado aunque se vea marcado en pantalla.
