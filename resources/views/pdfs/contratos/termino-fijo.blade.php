    ...
    <style>
        @page {
            /* Top/bottom ampliados 1.4cm/1.2cm sobre el original (2cm) para
               ...
               (ver membrete-empresa.blade.php) - dompdf posiciona los
               elementos `position: fixed` dentro del área de contenido, no
               en el margen físico, así que sin esta franja el logo y el pie
               chocan con el texto cuando el contenido llega hasta el borde. */
            margin: 3.4cm 2.3cm 3.2cm 2.3cm;
        }
       ...
       ========================================= */
        ...
        table.firma td .linea {
            border-top: 1px solid #000;
            margin: 0 15pt 5pt 15pt;
        }
...
<body>
    ...
    <table class="datos">
        ...
        <tr>
            <td class="label">FECHA DE TERMINACIÓN DE LABORES:</td>
            <td>{{ $fechaFin }}</td>
        </tr>
    </table>
    ...
    <ol>
        ...
        <li>Prestar sus servicios en forma exclusiva al Empleador; es decir, a no prestar directa ni indirectamente
            ...
            uso natural, los elementos, útiles y vehículos que se le entreguen para el desempeño de sus labores.</li>
        ...
        <li>Cumplir toda otra obligación y prohibición que se desprenda de las labores principales, anexas, conexas y
            complementarias que según lo anterior y de acuerdo con su cargo incumban al Trabajador(a).</li>
        <li>Guardar completa reserva de todo lo que llegue a su conocimiento en razón de su oficio y cuya divulgación
        ...
        <li>Utilizar los enseres, útiles, instrumentos, herramientas, vehículos y demás elementos que le entregue la
            empresa exclusivamente para los fines que le fueron suministrados.</li>
    ...
    <p><strong>PARÁGRAFO SEGUNDO:</strong> De conformidad con lo establecido en el literal i) del artículo 8º de la Ley
        ...
        modalidades, las exigencias que llegue a hacer el Empleador a el (la) Trabajador(a) para que cumpla con las
        estipulaciones contenidas en las cláusulas del presente contrato de trabajo, en especial la presente.</p>

    <p class="clausula"><span class="clausula-titulo">CUARTA: REMUNERACIÓN.</span> El Empleador reconocerá a el (la)
        Trabajador(a), como contraprestación por sus servicios la suma de {{ $salarioEnLetras }} como salario mensual.
        Cuando este desarrolle sus funciones laborales, pagadera por períodos vencidos de {{ $periodoPagoFrase }}, en
        {{ $lugarContratacion }}, o mediante consignación o transferencia electrónica a la cuenta bancaria que el (la)
        Trabajador(a) indique para el efecto. Dentro de este pago se encuentra incluida la remuneración de los descansos
        Dominicales y festivos de que tratan en los Capítulos I, II Y III del Título VII del C.S.T.</p>

    <p><strong>PARÁGRAFO PRIMERO:</strong> Las partes acuerdan que en los casos en que se le reconozcan al (a la)
        Trabajador(a) beneficios extralegales diferentes al salario, por concepto de alimentación, habitación o
        vivienda, transporte y vestuario, se considerarán tales beneficios o reconocimientos como los no salariales y
        por lo tanto no se tendrán en cuenta como factor salarial para la liquidación de acreencias laborales, ni el
        pago de aportes parafiscales (diferentes a los de la seguridad social), de conformidad con los artículos 15 y 16
        de la ley 50/90, en concordancia con el Art. 17 de la 344/96.</p>
    ...
    <p class="clausula"><span class="clausula-titulo">SEXTA: JORNADA DE TRABAJO.</span> EL (La) Trabajador(a) se obliga
        ...
        misma, según el artículo 167 ibidem. De igual manera, las partes podrán acordar que se preste el servicio en los
    ...
    <p><strong>PARÁGRAFO:</strong> En aplicación al artículo 161 del C.S.T. literal c y d, modificado por el artículo 2
        ...
        de 42 horas semanales dentro de la jornada ordinaria de 6 AM a 9 PM, el empleador no podrá, aun con el
    ...
    <p class="clausula"><span class="clausula-titulo">SÉPTIMA: DÍA DE DESCANSO OBLIGATORIO.</span> De conformidad con lo
        ...
        obligatorio el día domingo. En consecuencia, si el trabajador llegare a laborar durante dicho día de descanso
        obligatorio, el empleador reconocerá y pagará los recargos correspondientes.</p>

    <p class="clausula"><span class="clausula-titulo">OCTAVA: DURACIÓN Y PERÍODO DE PRUEBA.</span> La duración del
        presente contrato será la expresamente señalada en este documento. Sin embargo, si antes de la fecha de
        vencimiento del término estipulado, ninguna de las partes manifieste por escrito a la otra su decisión de no
        prorrogarlo, con una antelación no inferior a treinta (30) días, el contrato se entenderá renovado
        automáticamente por un período igual al inicialmente pactado. El contrato podrá prorrogarse hasta por tres (3)
        períodos. A partir de la cuarta prórroga, la renovación no podrá pactarse por un término inferior a un (1) año
        y, en lo sucesivo, deberá respetar dicho mínimo. En ningún caso, la sumatoria de las renovaciones podrá superar
        el término máximo de cuatro (4) años, conforme a lo previsto en la normatividad laboral vigente. Las partes
        acuerdan establecer un período inicial de prueba equivalente a la quinta parte de la duración total del
        contrato, sin que dicho lapso pueda exceder de dos (2) meses, contados a partir de la fecha de inicio de
        labores. Durante este período cualquiera de las partes podrá dar por terminado el contrato de manera unilateral,
        en cualquier momento, sin previo aviso ni indemnización por este concepto. No obstante, durante el período de
        prueba, el (la) trabajador(a) tendrá derecho a las prestaciones que la Ley determine a su favor.</p>

    <p class="clausula"><span class="clausula-titulo">NOVENA: TERMINACIÓN UNILATERAL.</span> Son justas causas para dar
        por terminado unilateralmente este contrato, por cualquiera de las partes, las enumeradas en los artículos 62 y
        63 del C.S.T., y además, por parte del Empleador, las faltas que para el efecto se califiquen como graves en
    ...
    <p class="clausula"><span class="clausula-titulo">DÉCIMA: OBLIGACIONES DEL (DE LA) TRABAJADOR(A).</span> En relación
        con la actividad propia del (de la) Trabajador(a), éste (a) la ejecutará dentro de las siguientes modalidades
        que implican claras obligaciones para el mismo trabajador, así:</p>
    ...
    <ol>
        ...
        <li>Cumplir con lo consagrado en el reglamento interno de trabajo, el de higiene y seguridad industrial y los
            demás reglamentos y políticas establecidas por la empresa.</li>
        ...
        <li>Realizar todas las funciones y cumplir con las responsabilidades establecidas al interior del manual de
            funciones y responsabilidades del cargo para el cual sea contratado. Ahora bien, el manual de funciones y
            responsabilidades será el Anexo No. 1 del presente contrato de trabajo.</li>
        <li>En general realizará todas las gestiones propias de su cargo, al igual que todas aquellas que afines o no a
            él, que se le encomienden y soliciten por parte de sus superiores jerárquicos, en forma verbal o escrita.
        </li>
    ...
    <p class="clausula"><span class="clausula-titulo">DÉCIMA PRIMERA: FALTAS GRAVES.</span> Los contratantes de común
    ...
    <ol>
        ...
        <li>El incumplimiento de cualquiera de las obligaciones estipuladas en la cláusula décima del presente contrato.
        </li>
        ...
        <li>La violación de la reserva de aspectos confidenciales puestos bajo la responsabilidad del Trabajador(a) o
            conocidos por éste en razón de su cargo.</li>
        ...
        <li>El cobro de subsidios o beneficios a los que no tiene legalmente derecho.</li>
        ...
        <li>La omisión o consignación de datos en forma inexacta en los informes, relaciones, proyectos crediticios,
            ...
            decisión que, a juicio del superior, habría sido diferente si los datos se ajustaran a la realidad.</li>
        <li>El solicitar u obtener, de los empleados bajo su mando, concesiones o beneficios valiéndose de su posición.
        </li>
        <li>El facilitar el código de usuario y contraseña asignados al (la) Trabajador(a) a compañeros de trabajo o
        ...
        <li>El embargo de cualquier acreencia laboral del (de la) Trabajador(a), siempre que no obtenga el levantamiento
            de dicha medida en un término máximo de treinta (30) días.</li>
        ...
        <li>La violación a las obligaciones y prohibiciones establecidas en la ley, el reglamento interno de trabajo,
            contrato de trabajo, el reglamento de higiene y seguridad, y demás políticas y reglamentos establecidos por
            la empresa.</li>
    ...
    <p class="clausula"><span class="clausula-titulo">DÉCIMA SEGUNDA: INCAPACIDADES.</span> Cuando se trate de comprobar
        ...
        sea transcrita o avalada por la EPS o ARL a la cual se encuentre vinculado el Trabajador(a).</p>

    <p class="clausula"><span class="clausula-titulo">DÉCIMA TERCERA: CONFIDENCIALIDAD.</span> El (La) Trabajador(a) se
        abstendrá, durante la vigencia del presente contrato o con posterioridad a su terminación por cualquier causa,
        de revelar, suministrar, vender, arrendar, publicar, copiar, reproducir, remover, disponer, transferir y en
        general utilizar directa o indirectamente en favor propio o de otras personas en forma total o parcial,
        cualquiera que sea su finalidad, información confidencial o privilegiada del Empleador o de las sociedades
        filiales, subsidiarias, matrices, subordinadas, relacionadas o empresas, personas naturales, accionistas,
        clientes o terceros relacionados con éste, a la cual tenga acceso o de la cual tenga conocimiento en desarrollo
        de su cargo o con ocasión de éste sin que medie autorización previa, expresa y escrita del Empleador para el
        efecto. Las Partes declaran que es de carácter confidencial cualquier información, documento o procedimiento del
        Empleador que no sea de conocimiento público, especialmente aquella información privilegiada respecto de
        operaciones, transacciones o negocios, o el valor de los mismos. El (La) Trabajador(a), a la terminación de su
        contrato de trabajo por cualquier causa, devolverá inmediatamente al Empleador cualquier documento, información
        o elemento que le haya sido entregado para efecto del cumplimiento de sus funciones. Las Partes acuerdan
        expresamente que el incumplimiento de las disposiciones contenidas en la presente cláusula es considerado como
        una falta grave y en tal sentido justa causa para la terminación del contrato de trabajo de acuerdo con lo
        dispuesto en el numeral 6 del literal a), Artículo 7 del Decreto Ley 2351 de 1965, en concordancia con el
        numeral 1 del Artículo 58 del C.S.T.</p>

    <p class="clausula"><span class="clausula-titulo">DÉCIMA CUARTA: DERECHOS DE AUTOR.</span> El (La) Trabajador(a)
        ...
        o de terceros vinculados de cualquier forma al Empleador. Como consecuencia de lo anterior, el Empleador tendrá
        derecho a solicitar, a su nombre o a nombre de terceros, y ante las autoridades correspondientes, el registro de
        las obras creadas por el (la) Trabajador(a). Asimismo, el Empleador podrá explotar comercialmente la obra por
        cualquier medio conocido o por conocerse, sin perjuicio de los derechos morales de autor que reposan en cabeza
        del autor de la obra.</p>

    <p><strong>PARÁGRAFO:</strong> Teniendo en cuenta lo dispuesto en la Ley 23 de 1982 y en el numeral 1° del artículo
        132 del Código Sustantivo del Trabajo, las Partes acuerdan que la remuneración salarial reconocida por el
        Empleador incluye y contiene la remuneración por la transferencia de los derechos patrimoniales de autor
        mencionados.</p>

    <p class="clausula"><span class="clausula-titulo">DÉCIMA QUINTA: PROPIEDAD INDUSTRIAL.</span> Todos los resultados
        obtenidos por el (la) Trabajador(a) en desarrollo de sus funciones o utilizando bienes, herramientas, equipos,
        materias primas o medios del Empleador, que sean susceptibles de ser protegidos por propiedad industrial, se
        entenderán que pertenecen al Empleador, lo que incluye pero no se limita a patentes, modelos de utilidad, diseño
        industrial y secreto comercial. El (la) Trabajador(a) deberá facilitar el cumplimiento oportuno de las
        correspondientes formalidades y firmar o extender los poderes y documentos necesarios para tal fin.</p>

    <p><strong>PARÁGRAFO:</strong> Teniendo en cuenta lo dispuesto en la Decisión 486 de 2000 de la Comunidad Andina de
        Naciones y en el numeral 1° del artículo 132 del Código Sustantivo del Trabajo, las Partes acuerdan que la
        remuneración salarial reconocida incluye la remuneración por la transferencia de los derechos de propiedad
        industrial mencionados.</p>

    <p class="clausula"><span class="clausula-titulo">DÉCIMA SEXTA: CAPACITACIONES.</span> El (La) Trabajador(a) se
        ...
        Empleador, ya sea mediante cursos dictados en el lugar de trabajo o en otras instalaciones.</p>

    <p class="clausula"><span class="clausula-titulo">DÉCIMA SÉPTIMA: AUTORIZACIÓN PARA LA GRABACIÓN DE IMAGEN.</span>
        El (La) Trabajador(a) autoriza por medio del presente documento al Empleador a utilizar su imagen para usos
        publicitarios del Empleador por tiempo indefinido y sin costo alguno. Igualmente, el (la) Trabajador(a) le cede
        expresamente al Empleador cualquier derecho sobre los documentos e imágenes obtenidas para dichos propósitos.
        Sin perjuicio de lo anterior, el (la) Trabajador(a) podrá oponerse por escrito al uso de su imagen.</p>

    <p class="clausula"><span class="clausula-titulo">DÉCIMA OCTAVA: MEDIOS DE TRABAJO.</span> El Empleador se obliga a
        proveer los medios de trabajo al (a la) Trabajador(a), dentro de los cuales podrán encontrarse: equipo de
        cómputo, papelería, entre otros.</p>

    <p><strong>PARÁGRAFO PRIMERO:</strong> Las herramientas de trabajo se encuentran bajo la custodia y cuidado del (de
        la) Trabajador(a) y su pérdida, daño o destrucción serán responsabilidad del (de la) Trabajador(a); igualmente
        constituye una falta grave meritoria de la terminación del contrato de trabajo. Las herramientas sólo podrán ser
        empleadas para las labores relacionadas con el contrato de trabajo.</p>

    <p><strong>PARÁGRAFO SEGUNDO:</strong> Las herramientas de trabajo entregadas al (a la) Trabajador(a) pertenecen al
        EMPLEADOR y por tanto el TRABAJADOR deberá devolverlas cuando se le solicite y en todo caso al momento de
        terminación de su contrato de trabajo por cualquier causa, autorizando desde ya que su valor se descuente de la
        liquidación final si no las devuelve.</p>

    <p><strong>PARÁGRAFO TERCERO:</strong> El suministro de las herramientas de trabajo no constituye salario ni
        beneficio legal o extralegal alguno, conforme lo previsto en los artículos 15 y 16 de la ley 50 de 1990 en
        concordancia con el artículo 17 de la ley 344 de 1996.</p>

    <p class="clausula"><span class="clausula-titulo">DÉCIMA NOVENA: DATOS PERSONALES.</span> El (La) Trabajador(a)
        ...
        conformidad con lo dispuesto en la ley 1581 de 2012 y el Decreto 1377 de 2013, para los fines internos que sean
        necesarios relacionados con la administración de talento humano, nómina, seguridad social y cumplimiento de
        obligaciones legales y contractuales.</p>

    <p class="clausula"><span class="clausula-titulo">VIGÉSIMA: DIRECCIÓN DEL TRABAJADOR.</span> El (La) Trabajador(a)
        para todos los efectos legales y en especial para la aplicación del parágrafo 1 del artículo 29 de la ley
        789/02, norma que modificó el 65 del C.S.T., se compromete a informar al Empleador cualquier cambio en su
        dirección de residencia. Toda comunicación o notificación que el Empleador deba hacer al Trabajador(a) se
        considera legal y válida si se hace a la última dirección de residencia, correo electrónico o número celular que
        el (la) Trabajador(a) haya registrado.</p>

    <p class="clausula"><span class="clausula-titulo">VIGÉSIMA PRIMERA: CONOCIMIENTO Y ACTUALIZACIÓN DE
    ...
    <p><strong>PARÁGRAFO PRIMERO:</strong> El (la) Trabajador(a) se obliga a cumplir la totalidad de los procedimientos
        antes mencionados y a mantenerse actualizado de otros procedimientos, políticas y normas que se establezcan en
        el futuro y resulten aplicables a la ejecución de sus funciones.</p>

    <p><strong>PARÁGRAFO SEGUNDO:</strong> El (la) Trabajador(a), en el caso de desempeñarse como jefe o persona que
        tiene a su cargo otros empleados, se obliga a propender porque sus subordinados se mantengan informados y
        actualizados sobre las normas, procedimientos y políticas del Empleador.</p>

    <p class="clausula"><span class="clausula-titulo">VIGÉSIMA SEGUNDA: AUTORIZACIÓN DE DESCUENTO.</span> El (La)
    ...
    <p><strong>PARÁGRAFO SEGUNDO:</strong> El (La) Trabajador(a) podrá autorizar por escrito a la Empresa para que, a la
        terminación del presente contrato, deduzca de las prestaciones sociales que le correspondan el valor de las
        obligaciones a su cargo y a favor de la Empresa por cualquier concepto.</p>

    <p class="clausula"><span class="clausula-titulo">VIGÉSIMA TERCERA: SISTEMA DE AUTOCONTROL Y GESTIÓN DEL RIESGO DE
        ...
        activos, financiación del terrorismo y demás delitos asociados. En desarrollo de lo anterior, el Trabajador(a)
        se compromete a: a) Abstenerse de realizar actos u operaciones que puedan constituir o facilitar actividades
        relacionadas con el lavado de activos o la financiación del terrorismo; b) Suministrar información veraz,
        completa y actualizada cuando le sea requerida por EL EMPLEADOR; c) Reportar de manera inmediata y confidencial
        cualquier operación inusual o sospechosa; d) Autorizar expresamente AL EMPLEADOR para verificar, consultar y
        reportar la información suministrada ante las bases de datos públicas y privadas, listas restrictivas y
        autoridades competentes, incluida la UIAF, cuando a ello hubiere lugar. El incumplimiento de estas obligaciones
        constituirá falta grave y dará lugar a la terminación del contrato de trabajo con justa causa.</p>

    <p class="clausula"><span class="clausula-titulo">VIGÉSIMA CUARTA: AUTORIZACIÓN PARA EL TRATAMIENTO DE DATOS
            PERSONALES.</span> El Trabajador(a), de manera libre, previa, expresa, informada e inequívoca, autoriza AL
        EMPLEADOR para recolectar, almacenar, usar, circular, actualizar, suprimir y, en general, realizar el
        tratamiento de sus datos personales, incluidos los datos sensibles, con finalidades como el cumplimiento de
        obligaciones legales y contractuales, la administración del talento humano, nómina y seguridad social, y el
        cumplimiento de políticas internas. El Trabajador(a) declara conocer que sus datos serán tratados conforme a la
        Ley 1581 de 2012 y el Decreto 1377 de 2013, y reconoce que le asisten los derechos de conocer, actualizar,
        rectificar y suprimir sus datos personales ante la Superintendencia de Industria y Comercio. La presente
        autorización permanecerá vigente durante la ejecución del contrato y con posterioridad a su terminación, por el
        tiempo necesario para el cumplimiento de obligaciones legales.</p>

    <p class="clausula"><span class="clausula-titulo">VIGÉSIMA QUINTA: EXÁMENES MÉDICOS.</span> El (La) Trabajador(a) se
        someterá a la práctica de los exámenes médicos o sanitarios o pruebas de laboratorio que el Empleador exija en
        cualquier momento.</p>

    <p><strong>PARÁGRAFO:</strong> En caso de que el (la) Trabajador(a) se niegue a practicar los exámenes médicos o
        pruebas de laboratorio a solicitud del Empleador, constituye falta grave y será meritoria de la terminación del
        contrato de trabajo con justa causa.</p>

    <p class="clausula"><span class="clausula-titulo">VIGÉSIMA SEXTA: MODIFICACIÓN DE LAS CONDICIONES LABORALES.</span>
        ...
        modificaciones no afecten su honor, dignidad o sus derechos mínimos, ni impliquen desmejoras sustanciales, de
        conformidad con lo dispuesto por el Art. 23 del C.S.T. modificado por el Art. 1º de la Ley 50/90.</p>

    <p class="clausula"><span class="clausula-titulo">VIGÉSIMA SÉPTIMA: NORMATIVIDAD.</span> Las Partes, conforme lo
        aceptan en este contrato, se someterán a todo lo estatuido en el C.S.T. y demás normas sobre derechos,
        obligaciones y prohibiciones emanados del contrato de trabajo.</p>

    <p class="clausula"><span class="clausula-titulo">VIGÉSIMA OCTAVA: EFECTOS.</span> El presente contrato reemplaza en
        su integridad y deja sin efecto cualquier otro contrato, acuerdo u oferta, verbal o escrito, celebrado entre las
        Partes con anterioridad, pudiendo las Partes convenir por escrito modificaciones al mismo.</p>

    <p class="clausula"><span class="clausula-titulo">VIGÉSIMA NOVENA: VIGENCIA.</span> Las Partes acuerdan que el
