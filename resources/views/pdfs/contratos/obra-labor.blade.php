{{--
    ...
    SolicitudContratoIAService::generarHTMLDesdeVista()):
      ...
      $descripcionObraLabor (texto simple, objeto/labor contratada)
      $duracionTerminacionRedactada (HTML crudo redactado por IA - trae sus
        propios bloques <p class="clausula"><span class="clausula-titulo">
...
<body>
    ...
    <table class="tabla-mapa">
        ...
        <tr>
            <td><a class="mapa-link" href="#parte-07"><img src="{{ $icono('parte-07') }}" alt=""><span class="mapa-texto"><span class="mapa-titulo-item">7. Duración y período de prueba</span>Cuánto dura la obra o labor y tu período de prueba.</span></a></td>
