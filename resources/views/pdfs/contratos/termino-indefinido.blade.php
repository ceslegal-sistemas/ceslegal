{{--
    Contrato Individual de Trabajo a Término Indefinido - "Legal Design" del
    jefe, mismo tratamiento aplicado a Término Fijo (ver termino-fijo.blade.php).
    El texto reutiliza verbatim las ~15 secciones que son idénticas en
    sustancia entre los 3 tipos de contrato (obligaciones, salario, jornada,
    terminación, confidencialidad, propiedad intelectual, herramientas, datos
    personales, políticas, descuentos, glosario, etc.) - solo la PARTE 07
    "Duración y período de prueba" cambia: un contrato a término indefinido
    no tiene fecha de finalización, tope de 4 años ni prórrogas, y su período
    de prueba es un tope fijo de 2 meses (no la quinta parte de una duración
    total que aquí no existe). Base factual tomada del texto literal que
    tenía este archivo antes de la migración a Legal Design (cláusulas
...
<body>
    ...
    <div class="portada">
        ...
        <h1>Contrato de Trabajo a Término Indefinido</h1>
    </div>
    ...
    <table class="tabla-datos">
        ...
        <tr><td class="label">Duración</td><td>Indefinida</td></tr>
    ...
    {{-- Único bloque que difiere de Término Fijo: sin fecha de fin, sin tope
         de 4 años, sin prórrogas - la relación no tiene plazo. Período de
         prueba fijo de 2 meses (no una quinta parte de una duración total
         que aquí no existe), base factual de la cláusula SÉPTIMA original. --}}
    {!! $parteHeader(7, 'Duración y período de prueba') !!}
    <div class="caja caja--simple">
        <p class="caja-titulo"><img src="{{ $icono('callout-simple') }}" alt="">En palabras simples</p>
        <p>Este contrato no tiene una fecha de terminación: dura mientras ambas partes decidan continuar la relación laboral. Al iniciar, hay un período de prueba de hasta 2 meses en el que cualquiera de las partes puede terminar el contrato sin indemnización.</p>
    </div>
    <table class="tabla-datos">
        <tr><td class="label">Duración</td><td>Indefinida. El contrato continúa vigente mientras no se dé por terminado por alguna de las causas legales o pactadas en este documento.</td></tr>
