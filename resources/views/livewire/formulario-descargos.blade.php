        ...
        <div
            ...
            <main class="px-4 sm:px-6 py-6">
                ...
                @elseif ($etapa === 'foto_inicio')
                    @include('livewire.partials.verificacion-facial-descargos', [
                        'fase'           => 'inicio',
                        'titulo'         => 'Verificación fotográfica',
                        'subtitulo'      => 'Tome una foto de su rostro para registrar el inicio de la diligencia.',
                        'textoConfirmar' => 'Confirmar foto',
                    ])
                ...
                @elseif ($etapa === 'foto_fin')
                    @include('livewire.partials.verificacion-facial-descargos', [
                        'fase'           => 'fin',
                        'titulo'         => 'Verificación fotográfica - Cierre',
                        'subtitulo'      => 'Tome una foto de su rostro para registrar el fin de la diligencia y enviar sus descargos.',
                        'textoConfirmar' => 'Confirmar y enviar',
                    ])
