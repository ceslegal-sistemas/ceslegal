...
<body>
    ...
    <div class="content">
        ...
        <p>Por medio del presente, se le notifica que ha sido citado(a) a una audiencia de descargos relacionada con el proceso disciplinario <strong>{{ $proceso->codigo }}</strong>.</p>
        ...
        <div class="important">
            ...
            <p style="font-size: 18px; margin: 10px 0;">
                <strong>{{ \Carbon\Carbon::parse($proceso->fecha_descargos_programada)->locale('es')->isoFormat('dddd, D [de] MMMM [de] YYYY [a las] h:mm A') }}</strong>
            </p>
        ...
        <div class="info-box">
            ...
            <p>Encontrará adjunto a este correo el documento oficial de citación con todos los detalles del proceso y sus derechos.</p>
        ...
        <div class="info-box" style="background-color: #dbeafe; border-left-color: #3b82f6;">
            ...
            <p>Podrá presentar sus descargos a través de nuestro formulario en línea, el cual estará disponible <strong>únicamente el día de la audiencia</strong>.</p>
            ...
            <p style="font-size: 13px; color: #6b7280;">
                <strong>Nota importante:</strong> Este enlace es personal e intransferible. Solo estará activo el día programado para la audiencia.
        ...
        <p>Si tiene alguna pregunta o requiere información adicional, por favor comuníquese con el área de Recursos Humanos de {{ $empresa->razon_social }}.</p>
