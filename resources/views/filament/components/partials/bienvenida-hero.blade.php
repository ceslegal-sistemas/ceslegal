...
@verbatim
    <style>
        ...
        @keyframes bv-ember-rise {
            ...
            100% {
                transform: translateY(-320px) translateX(var(--drift, 20px)) scale(.2);
                opacity: 0;
            }
        }
        ...
        @keyframes bv-float-blue {
            ...
            80% {
                transform: translate(-8px, 22px) scale(1.04)
            }
        ...
        @keyframes bv-float-gold {
            ...
            60% {
                transform: translate(-12px, 10px) scale(.88)
            }

            85% {
                transform: translate(8px, -14px) scale(1.06)
            }
...
<div style="display:flex;flex-direction:column;gap:1.375rem;padding:.25rem 0;">
    ...
    <div class="bv-hero bv-a1" id="{{ $uid }}_hero">
        ...
        <div style="position:relative;z-index:2;">
            ...
            <h1 class="bv-title t-h bv-title-shadow">{{ $title }}</h1>

            <div style="display:flex;gap:.5rem;margin-top:1.125rem;flex-wrap:wrap;justify-content:center;">
                <p class="t-m bv-subtitle-wrap"
                    style="font-weight:500;font-size:.875rem;line-height:1.65;margin:0;text-align:center;text-shadow:0 1px 10px rgba(0,0,0,.0);">
                    {!! $subtitle !!}
                </p>
            </div>
        </div>
    ...
    <div class="bv-a2">
        <div class="bv-rule">
            ...
            <span class="bv-rule-label t-dl">{{ $ruleLabel }}</span>
            <div class="bv-rule-line bv-rule-line-c"></div>
        </div>
    ...
    (function() {
        ...
        document.querySelectorAll('#' + UID + '_steps .bv-step-item').forEach(function(el) {
            el.addEventListener('mousemove', function(e) {
                ...
                el.style.transform = 'perspective(800px) rotateX(' + rx + 'deg) rotateY(' + ry +
                    'deg) scale(1.035)';
