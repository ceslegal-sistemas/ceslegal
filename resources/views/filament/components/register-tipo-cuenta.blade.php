...
<style>
    ...
    .rtc-card:hover{transform:translateY(-2px);box-shadow:0 10px 26px rgba(225,29,72,.10)}
    html.dark .rtc-card{background:rgba(255,255,255,.03);border-color:rgba(255,255,255,.12)}
    .rtc-card.rtc-on{border-color:#e11d48;box-shadow:0 8px 26px rgba(225,29,72,.18)}
    html.dark .rtc-card.rtc-on{border-color:#fb7185}
    ...
    html.dark .rtc-check{color:#fb7185}
</style>
@endonce
