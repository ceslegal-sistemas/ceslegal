@php
    ...
    $steps = [
        ...
        ['n' => '4', 'sc' => '#a78bfa', 'ib' => 'rgba(167,139,250,.12)', 'ibc' => 'rgba(167,139,250,.25)', 'tag' => 'Paso 4', 'title' => 'Salario', 'body' => 'Especifique la forma y periodicidad de pago, comisiones, beneficios y la política de permisos e incapacidades.'],
