...
<div class="ers-wrap">
    <style>
        ...
        html.dark .ers-on .ers-head{background:linear-gradient(135deg,rgba(225,29,72,.16),rgba(249,115,22,.14))}
        ...
        .ers-badge{margin-left:auto;font-size:.66rem;font-weight:700;letter-spacing:.06em;text-transform:uppercase;
            padding:.25rem .65rem;border-radius:100px}
        .ers-badge.ok{background:rgba(22,163,74,.12);color:#15803d} html.dark .ers-badge.ok{background:rgba(22,163,74,.2);color:#86efac}
        ...
        .ers-btn:hover{filter:brightness(1.05)}
        .ers-btn svg{width:15px;height:15px}
