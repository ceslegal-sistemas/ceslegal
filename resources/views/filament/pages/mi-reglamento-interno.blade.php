        ...
        @elseif(!$estaGenerando)
          ...
          @if($tiene)
            ...
            @if(auth()->user()?->hasRole('super_admin'))
              ...
              {{-- Solo tiene sentido para RIT subido/redactado libremente - un RIT
                   construido con el wizard ya trae los cargos estructurados por el
                   propio cliente (respuestas_cuestionario['cargos']), ver
                   ReglamentoInternoService::cargosDeEmpresa(). --}}
              @if(empty($reglamento?->respuestas_cuestionario['cargos'] ?? []))
                <button wire:click="mountAction('generarOrganigrama')" class="rit-btn rit-btn-secondary">
