...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ══ Portada (sin @page cover — respeta márgenes normales) ══════════════ */
        .cover { page-break-after: always; }
        .cv-top {
            background: #0d1f3c;
            padding: 3cm 2cm 2.5cm 2cm;
            text-align: center;
        }
        .cv-eyebrow {
            font-size: 7pt; letter-spacing: 0.22em; text-transform: uppercase;
            color: #6b8cad; margin-bottom: 1.5cm;
        }
        .cv-pretitle {
        ...
        .cv-rule { display: block; width: 3cm; height: 2.5pt; background: #c9a84c; margin: 0.8cm auto; }
        ...
        .cv-badge {
            ...
            padding: 3pt 8pt; margin-top: 1cm;
        }
        .cv-bottom {
        ...
        .cv-meta td { text-align: center; vertical-align: middle; padding: 0 0.6cm; }
...
{{-- ══ PORTADA (dentro de márgenes normales) ══ --}}
<div class="cover">
    <div class="cv-top">
        ...
        <table cellpadding="0" cellspacing="0" align="center" style="margin-top:0.7cm">
            <tr><td>
        ...
        <div style="margin-top:0.8cm"><span class="cv-badge">VERSIÓN TÉCNICA — CONFIDENCIAL</span></div>
    </div>
    <div class="cv-bottom">
        <div class="cv-meta">
            <table><tr>
...
<table width="100%" cellpadding="0" cellspacing="0" style="border-top:1pt solid #e5e7eb; margin-top:4pt">
    <tr>
